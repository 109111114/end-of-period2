<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="end_of_period2.menu" %>
            ...
            <div class="container">
                ...
                <div id="menu" class="widget-content">
                    <ul class="columns menuList">
                        <li><a href="menu.aspx" class="select">總覽<span class="menu-jp">(全メニュー)</span></a></li>
                    ...
                    <div class="text">
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span style="background-color: #1C1C1C;">豚骨拉麵</span><span style="background-color: #1C1C1C;" class="menu-header-jp">(豚骨ラーメン)</span></h3>
                            </div>
                            <div class="menu-info">
                                <p>
                            ...
                            <div class="proListBox">
                                ...
                                <div class="clear"></div>
                                <a href="menuList.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>沾麵</span><span class="menu-header-jp">(つけ麺)</span></h3>
                            </div>
                            <div class="menu-info">
                                <p>蕃茄口味的沾麵，取小部分的麵和配料，沾過沾醬食用，除了吃麵、喝湯，最後還可以來一碗泡飯，真是大滿足啊! 　</p>
                            </div>
                            ...
                            <div class="proListBox">
                                <ul class="columns proList">
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/29.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">蕃茄豚骨沾麵</p>
                                            <p class="name-jp">(トマ豚骨つけ麺)</p>
                                            <p class="price">$250</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/47.png" width="196" height="122" />
                                            </div>

                                            <p class="inco-push"></p>
                                        </div>
                                        <div class="info">
                                            <p class="name">叉燒蕃茄豚骨沾麵</p>
                                            <p class="name-jp">(叉焼トマ豚骨つけ麺)</p>
                                            <p class="price">$290</p>
                                        </div>
                                    </a></li>
                                ...
                                <div class="clear"></div>
                                <a href="menuList2.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>期間限定</span><span class="menu-header-jp"></span></h3>
                            </div>
                            <div class="menu-info">
                                <p>隨季節變換的拉麵口味，好吃又新鮮!</p>
                            </div>
                            ...
                            <div class="proListBox">
                                <ul class="columns proList">
                                    <li><a class="proList-long">
                                        ...
                                        <div class="info">
                                            <p class="name">黑麻油生姜豚骨拉麵</p>
                                            <p class="name-jp">(生姜香る豚骨ラーメンごま油風味)</p>
                                            <p class="price">$260</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        ...
                                        <div class="info">
                                            <p class="name">叉燒黑麻油生姜豚骨拉麵</p>
                                            <p class="name-jp">(チャーシュー生姜香る豚骨ラーメンごま油風味)</p>
                                            <p class="price">$300</p>
                                        </div>
                                    </a></li>
                                ...
                                <div class="clear"></div>
                                <a href="menuList3.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>各店限定拉麵</span><span class="menu-header-jp">(各店限定)</span></h3>
                            </div>
                            <div class="menu-info">
                            ...
                            <div class="proListBox">
                                <ul class="columns proList">
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/31.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/51.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/120.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/126.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/118.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/277.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/275.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/512.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/515.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/513.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/197.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/196.png" width="196" height="122" />
                                            </div>
                                ...
                                <div class="clear"></div>
                                <a href="menuList4.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>飯</span><span class="menu-header-jp">(ご飯物)</span></h3>
                            </div>
                            <div class="menu-info">
                            ...
                            <div class="proListBox">
                                ...
                                <div class="clear"></div>
                                <a href="menuList5.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>單品   </span><span class="menu-header-jp">(一品料理)</span></h3>
                            </div>
                            <div class="menu-info">
                                <p>完全日本口味，是拉麵的好搭擋! 【單品料理每家店銷售種類不定，依各店為主】</p>
                            </div>
                            ...
                            <div class="proListBox">
                                ...
                                <div class="clear"></div>
                                <a href="menuList6.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>麵配料</span><span class="menu-header-jp">(トッピング)</span></h3>
                            </div>
                            <div class="menu-info">
                            ...
                            <div class="proListBox">
                                ...
                                <div class="clear"></div>
                                <a href="menuList7.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>飲料</span><span class="menu-header-jp">(ドリンク)</span></h3>
                            </div>
                            <div class="menu-info">
                                <p>點拉麵+30元，可搭配40元飲料一杯</p>
                            </div>
                            ...
                            <div class="proListBox">
                                <ul class="columns proList">
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/282.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">可口可樂</p>
                                            <p class="name-jp">(コカコーラ)</p>
                                            <p class="price">$40</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/321.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">檸檬紅茶</p>
                                            <p class="name-jp">(レモンティー)</p>
                                            <p class="price">$40</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/395.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">薑汁汽水</p>
                                            <p class="name-jp">(ジンジャーエール)</p>
                                            <p class="price">$50</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/317.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">可爾必思</p>
                                            <p class="name-jp">(カルピス)</p>
                                            <p class="price">$50</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/285.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">朝日啤酒(瓶)</p>
                                            <p class="name-jp">(アサヒビール)</p>
                                            <p class="price">$120</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/287.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">冰梅酒</p>
                                            <p class="name-jp">(梅酒)</p>
                                            <p class="price">$120</p>
                                        </div>
                                    </a></li>
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/319.png" width="196" height="122" />
                                            </div>

                                        </div>
                                        <div class="info">
                                            <p class="name">清酒</p>
                                            <p class="name-jp">(日本酒)</p>
                                            <p class="price">$140</p>
                                        </div>
                                    </a></li>
                                ...
                                <div class="clear"></div>
                                <a href="menuList8.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>甜點</span><span class="menu-header-jp">(デザート)</span></h3>
                            </div>
                            <div class="menu-info">
                                <p>吃完拉麵，再來個甜點布丁，最滿足的日式享受! 點拉麵+100元，可搭配40元飲料一杯及日式純手工烤布丁一個</p>
                            </div>
                            ...
                            <div class="proListBox">
                                ...
                                <div class="clear"></div>
                                <a href="menuList9.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="proBox">
                            <div class="menu-header">
                                <h3><span>把樂麵屋搬回家</span><span class="menu-header-jp"></span></h3>
                            </div>
                            <div class="menu-info">
                                <p>材料幫你準備好，讓你在家也能樂麵屋♪只要跟著內附的說明書步驟做，就可以在家吃到跟樂麵屋一樣好吃的拉麵一起享受在自家「屋」裡煮拉「麵」的「樂」趣吧 ♫</p>
                            </div>
                            ...
                            <div class="proListBox">
                                <ul class="columns proList">
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/435.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/437.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/439.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/441.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/445.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/447.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/449.png" width="196" height="122" />
                                            </div>
                                    ...
                                    <li><a class="proList-long">
                                        <div class="pic">
                                            <div class="img">
                                                <img src="UploadsMenu/451.png" width="196" height="122" />
                                            </div>
                                ...
                                <div class="clear"></div>
                                <a href="menuList10.aspx" class="proMore fr">更多</a>
                                <div class="clear"></div>
                            </div>
                        </div>
