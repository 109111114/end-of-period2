        ...
        <div id="content-wrapper">
            <div class="container">
                <div class="widget-header">
                    ...
                    <div class="sitelink"><a href="home.aspx">首頁</a><a href="about.aspx">關於我們</a><a href="about5.aspx">聯絡我們</a></div>
                </div>
                    ...
                    <div id="about" class="widget-content">
                        <div class="text">
                            <p style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify; font-size: 16px; position: relative; top: 10px; left: -7px;">
                                <span style="font-family: Arial, Verdana, sans-serif; font-size: 12px;">感謝您瀏覽我們的網站。 如果您有任何意見或疑問， 請與我們聯繫。</span>
                            </p>
                            <p style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify; font-size: 16px; position: relative; top: 10px; left: -7px;">
                                <span style="font-family: Arial, Verdana, sans-serif; font-size: 12px;">E-mail：service@tarokofood.com.tw</span>
                            </p>
                            <p>
                                &nbsp;
                            </p>
