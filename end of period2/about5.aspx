<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about5.aspx.cs" Inherits="end_of_period2.about5" %>
          ...
          <!--  <li class="main-item"><a href="home.aspx" class="main-item-a m5 "><span>拉麵小學堂</span></a></li>-->
            ...
            <div id="content-wrapper">
                <div class="container">  
                        ...
                        <div class="sitelink"><a href="index.aspx">首頁</a><a href="about.aspx">關於我們</a><a href="about.aspx?d=5">聯絡我們</a></div>
                    </div>
                    <article id="content" class="widget-page">
                        <div id="about" class="widget-content">
                            <div class="text">
                                <p style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify; font-size: 16px; position: relative; top: 10px; left: -7px;">
	<span style="font-family: Arial, Verdana, sans-serif; font-size: 12px;">感謝您瀏覽我們的網站。 如果您有任何意見或疑問， 請與我們聯繫。</span></p>
<p style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify; font-size: 16px; position: relative; top: 10px; left: -7px;">
	<span style="font-family: Arial, Verdana, sans-serif; font-size: 12px;">E-mail：service@tarokofood.com.tw</span></p>
<p>
	&nbsp;</p>
