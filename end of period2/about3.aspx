        ...
        <div id="content-wrapper">
            <div class="container">
                <div class="widget-header">
                    ...
                    <div class="sitelink"><a href="home.aspx">首頁</a><a href="about.aspx">關於我們</a><a href="about3.aspx">仕事人</a></div>
                </div>
                <article id="content" class="widget-page">
                    <div id="about" class="widget-content">
                        <div class="text">
                            <h4 style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify; font-size: 16px; position: relative; top: 10px; left: -7px;">【仕事人】</h4>
                            <p>
                                &nbsp;
                            </p>
                            <p style="line-height: 1.5em; margin: 0px; padding: 0px; font-size: 14px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify;">
                                伯耆明子小姐，日籍行政主廚，日式料理的堅持，再加一點明子式創意
                            </p>
                            <p>
                                &nbsp;
                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <p style="line-height: 1.5em; margin: 0px; padding: 0px; font-size: 14px;">
                                                ...
                                                明子小姐在研發中的專注神情都能讓人感受到她對料理的熱愛，有著兩種身分的她，不變的是她的用心，在每一道料理上都嶄露無遺。
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
