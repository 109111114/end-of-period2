<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuList3.aspx.cs" Inherits="end_of_period2.menuList3" %>
                ...
                <div class="container">
                    ...
                    <div id="menu" class="widget-content">
                        <ul class="columns menuList">
                            ...
                            <li><a href="menuList3.aspx" class="select">期間限定<span class="menu-jp"></span></a></li>
                        ...
                        <div class="text">
                            <div class="proBox">
                                <div class="menu-header">
                                    <h3><span style="background-color: #1C1C1C;">期間限定</span><span class="menu-header-jp" style="background-color: #1C1C1C;"></span></h3>
                                </div>
                                <div class="menu-info">
