<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuList8.aspx.cs" Inherits="end_of_period2.menuList8" %>
                ...
                <div class="container">
                    ...
                    <div id="menu" class="widget-content">
                        <ul class="columns menuList">
                            ...
                            <li><a href="menuList8.aspx" class="select">飲料<span class="menu-jp">(ドリンク)</span></a></li>
                        ...
                        <div class="text">
                            <div class="proBox">
                                <div class="menu-header">
                                    <h3><span style="background-color: #1C1C1C;">飲料</span><span class="menu-header-jp" style="background-color: #1C1C1C;">(ドリンク)</span></h3>
                                </div>
                                <div class="menu-info">
