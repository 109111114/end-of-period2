        ...
        <div id="content-wrapper">
            <div class="container">
                <div class="widget-header">
                    ...
                    <div class="sitelink"><a href="home.aspx">首頁</a><a href="about.aspx">關於我們</a><a href="about.aspx">日本總社</a></div>
                </div>
                <article id="content" class="widget-page">
                    <div id="about" class="widget-content">
                        <div class="text">
                            <h4 style="line-height: 1.8em; margin: 0px; padding: 0px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; font-size: 16px; position: relative; top: 10px; left: -7px;">【日本總社】</h4>
                            <p>
                                <img height="423" src="styles/images/inside001_pic.png" style="font-size: 14px; line-height: 1.5em; border: 0px;" width="670"/>
                            </p>
                            <p>
                                &nbsp;
                            </p>
                            <p style="line-height: 1.5em; margin: 0px; padding: 0px; font-size: 14px; color: rgb(255, 255, 255); font-family: 微軟正黑體, 新細明體, Arial; letter-spacing: 1px; text-align: justify;">
                                ...
                                <br/>
                                具有部份台灣血統的現任代表取締役坂田健先生賦與台灣分公司的唯一使命，就是將純正日本美食帶到台灣<span style="line-height: 1.5em;">！希望這個分公司能擁有台灣人開創進取的精神，加上日本職人的堅持態度。</span>
                            </p>
                            <p>
                                &nbsp;
                            </p>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="line-height: 1.5em; margin: 0px; padding: 0px; font-size: 14px;">
                                                樂麵屋是由日本總公司直接在台灣所創立經營，有別於本地的公司代理日本既有拉麵品牌。建立直營的新品牌目的在於能夠即時以日本的標準直接管控餐點品質，同時不需背負既有品牌的限制，更能提出創新的做法及口味！這也是為什麼每個樂麵屋的分店都有不同的裝潢，氣氛及不同口味的特色拉麵，因為我們痛恨重複，創新求變和追求美味是根植在我們的基因裏的啊！
                                            </p>
                                        </td>
                                        <td>
